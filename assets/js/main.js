(function ($) {
    ...
    function updateText() {
        var target = $('.ft-text-a');
      
        TweenMax.to(target, 3, {text:{value:"Is too much work!", delimiter:""}, ease:Linear.easeNone});
      }
    ...
    $slogans.parent().css({ position: "absolute", top: "0px", left: "50%", transform: "translateX(-50%)" });
    ...
    const swiper = new Swiper(".swiper", {
        ...
        autoplay: {
            ...
            reverseDirection: true // Reverse the direction during autoplay
        },
